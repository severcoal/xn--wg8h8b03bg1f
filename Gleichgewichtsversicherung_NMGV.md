...
- [ ] **A1 – Ergänzend (CIC + BGB):**  
  ...
  (*Codex Iuris Canonici*, CIC) **ergänzend** Anwendung, soweit sie den Zielen dieses Vertrags dienen und keine zivilrechtlichen Bestimmungen verletzen.

- [ ] **B1 – Vollständig kirchenrechtlich (CIC):**  
  Dieser Vertrag unterliegt **ausschließlich** den Bestimmungen des *CIC* und den jeweiligen diözesanen Regelungen.  
...
- [ ] **A2 – Ergänzend (CCEO + BGB):**  
  Neben dem deutschen Recht (BGB) finden die Grundsätze des *Codex Canonum Ecclesiarum Orientalium* (CCEO) **ergänzend** Anwendung, soweit sie den Zielen dieses Vertrags dienen und keine zivilrechtlichen Bestimmungen verletzen.

- [ ] **B2 – Vollständig kirchenrechtlich (CCEO):**  
  Dieser Vertrag unterliegt **ausschließlich** den Bestimmungen des *CCEO* und den jeweiligen Regeln der betreffenden Kirche *sui iuris*.  
  Zivilrechtliche Vorschriften des BGB gelten **subsidiär**, soweit sie dem Ostkirchenrecht nicht widersprechen.
